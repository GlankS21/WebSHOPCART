        ...
        <form class="customer-info">
            ...
            <div class="form-grid">
                <div class="input-group">
                    ...
                    <input type="text" id="fullName" placeholder="Иван Петров" required>
                </div>
                <div class="input-group">
                    <label for="phone">Телефон</label>
                    <input type="tel" id="phone" placeholder="+7 996 999 65 56" required>
                </div>
                <div class="input-group full-width">
                    <label for="email">Почта</label>
                    <input type="email" id="email" placeholder="petrov@ya.ru" required>
                </div>
                <div class="input-group">
                    <label for="region">Регион доставки</label>
                    <input type="text" id="region" placeholder="Самарская область" required>
                </div>
                <div class="input-group">
                    <label for="city">Город доставки</label>
                    <input type="text" id="city" placeholder="Самара" required>
                </div>
                <div class="input-group full-width">
                    <label for="street">Улица</label>
                    <input type="text" id="street" placeholder="Пушкина" required>
                </div>
                </div>
        </form>
